...
// Images
import DevShalaLogo from "../../assets/Logo/devshala-logo.svg";
          ...
          <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3">
            <div className="w-[30%] flex flex-col gap-3 lg:w-[30%] mb-7 lg:pl-0">
              <div className="flex flex-row items-center gap-2">
                ...
                />
                <span className="text-richblack-50 font-semibold text-lg">DevShala</span>
              </div>
      ...
      <div className="flex flex-row items-center justify-between w-11/12 max-w-maxContent text-richblack-400 mx-auto pb-14 text-sm">
        ...
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          ...
          <div className="text-center flex flex-col sm:flex-row ">
            <span> Made with ❤️ by Tejas Rastogi © 2026 DevShala</span>
          </div>

          <div className="flex items-center">
            <a
              href="https://www.linkedin.com/in/tejas-rastogi-292b81231?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
            ...
            <a
              href="https://github.com/tejasrastogileet"
              className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300"
              target="_blank"
              rel="noopener noreferrer"
            >
