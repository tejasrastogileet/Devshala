...
import devshalaIcon from '../../assets/Logo/devshala-icon.svg'
import { getAllCatalogNames, catalogData } from './../../data/catalogData';
...
const Navbar = () => {
    ...
    // Static catalog links
    const catalogLinks = getAllCatalogNames().map((name) => ({
        name: catalogData[name].pageTitle,
        slug: name,
    }));
        ...
        <nav className={`z-[10] flex h-14 w-full items-center justify-center border-b-[1px] border-b-richblack-700 text-white translate-y-0 transition-all ${showNavbar} `}>
            ...
            <div className='flex w-11/12 max-w-maxContent items-center justify-between '>
                ...
                <Link to="/" className='flex items-center gap-2'>
                    <img src={devshalaIcon} alt="DevShala Logo" width={45} height={45} loading='lazy' />
                    <span className='hidden sm:block text-richblack-25 font-bold text-lg'>DevShala</span>
                </Link>
                </div>
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                {catalogLinks.length ? (
                                                    ...
                                                    <p className="text-center text-sm">No categories available. Please check back later.</p>
                                                )}
                                            </div>
                                        </div>
                                    ) : (
